...
@JvmOverloads constructor(
     ...
     * @see DragShadow
     */
    public var itemDragShadow: DragShadow
     ...
     * @see DragShadow
     */
    public var listDragShadow: DragShadow
    ...
    init {
        ...
        boardView = findViewById(R.id._boardView)
        itemDragShadow = findViewById(R.id.item_dragShadow)
        listDragShadow = findViewById(R.id.list_dragShadow)
