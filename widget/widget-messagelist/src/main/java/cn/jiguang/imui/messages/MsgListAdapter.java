...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    private OnShowRender<MESSAGE> messageOnShowRender;
    ...
    public MsgListAdapter(HoldersConfig holders, ImageLoader imageLoader) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            default:
                ...
                Log.e("getHolder", "mSendTxtLayout");
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (wrapper.item instanceof IMessage) {
            ...
            ((BaseMessageViewHolder) holder).onShowRender = this.messageOnShowRender;
    ...
    /**
     * Returns selected messages text and do {@link #deselectAllItems()} for you.
     *
    ...
    /**
     * Copies text to device clipboard and returns selected messages text. Also it does {@link #deselectAllItems()} for you.
     *
    ...
    public interface OnShowRender<MESSAGE extends IMessage> {
        void onShowRender(View view, MESSAGE message);
    }

    public void setMessageOnShowRender(OnShowRender<MESSAGE> messageOnShowRender) {
        this.messageOnShowRender = messageOnShowRender;
    }
