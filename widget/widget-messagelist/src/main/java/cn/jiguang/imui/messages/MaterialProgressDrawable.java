...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        final int shadowYOffset = DisplayUtil.dp2px(mParent.getContext(), Y_OFFSET);
        final int shadowXOffset = DisplayUtil.dp2px(mParent.getContext(), X_OFFSET);
        int mShadowRadius = DisplayUtil.dp2px(mParent.getContext(), SHADOW_RADIUS);
