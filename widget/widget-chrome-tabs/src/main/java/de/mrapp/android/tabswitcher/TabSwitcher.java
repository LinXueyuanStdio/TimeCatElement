...
/**
 * 这是一个仿 Chrome Android 的选项卡切换控件
 *
 * {@link TabSwitcherDecorator} 定义每个tab的样式
 *
 * 当前选中的tab默认全屏显示。showSwitcher 显示所有tab的总览图。
 * 点击->激活一个tab
 * 点击删除图标或左右滑->删除一个tab
 *
 * setSelectedTab直接选中一个指定的tab
 *
 * {@link Tab}表示一个tab，可以动态地加入本切换器中。
