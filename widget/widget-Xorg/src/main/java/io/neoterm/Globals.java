...
public class Globals {
  ...
  public static String XLIB_DIR = "/data/data/com.time.cat/files/usr/lib/xorg-neoterm";
  ...
  public static String[] DataDownloadUrl = {"!!Data files|:data.tar.gz:data-1.tgz",
      "!!Data files|:DroidSansMono.ttf:DroidSansMono.ttf",
      "Additional fonts (90Mb)|:xfonts.tar.gz:http://sourceforge.net/projects/libsdl-android/files/apk/XServer-XSDL/xfonts.tgz/download",};
  ...
  public static String[] AppTouchscreenKeyboardKeysNames = "LCTRL LALT LSHIFT RETURN SPACE DELETE KP_PLUS KP_MINUS 1 2"
      .split(" ");
  ...
  public static SettingsMenu.Menu FirstStartMenuOptions[] = {
      new SettingsMenuMisc.GyroscopeCalibration(), new SettingsMenuMisc.OptionalDownloadConfig(),};
  ...
  public static int LeftClickMethod =
      ForceRelativeMouseMode ? Mouse.LEFT_CLICK_WITH_TAP_OR_TIMEOUT : Mouse.LEFT_CLICK_NORMAL;
  ...
  public static int RightClickMethod =
      AppNeedsTwoButtonMouse ? Mouse.RIGHT_CLICK_WITH_MULTITOUCH : Mouse.RIGHT_CLICK_NONE;
  ...
  public static int ScreenKbControlsLayout[][] =
      AppUsesThirdJoystick ? // Values for 800x480 resolution
          new int[][]{{0, 303, 177, 480}, {0, 0, 48, 48}, {400, 392, 488, 480},
              {312, 392, 400, 480}, {400, 304, 488, 392}, {312, 304, 400, 392},
              {400, 216, 488, 304}, {312, 216, 400, 304}, {623, 303, 800, 480},
              {623, 126, 800, 303}} :
          AppUsesSecondJoystick ?
              new int[][]{{0, 303, 177, 480}, {0, 0, 48, 48}, {400, 392, 488, 480},
                  {312, 392, 400, 480}, {400, 304, 488, 392}, {312, 304, 400, 392},
                  {400, 216, 488, 304}, {312, 216, 400, 304}, {623, 303, 800, 480}} :
              new int[][]{{0, 303, 177, 480}, {0, 0, 48, 48}, {712, 392, 800, 480},
                  {624, 392, 712, 480}, {712, 304, 800, 392}, {624, 304, 712, 392},
                  {712, 216, 800, 304}, {624, 216, 712, 304}};
  ...
  public static String DataDir = "/data/data/com.time.cat/files/usr/share/xorg-neoterm";
  public static String UnSecureDataDir = "/data/data/com.time.cat/files/usr/share/xorg-neoterm";
  public static String HomeDir = "/data/data/com.time.cat/files/home";
